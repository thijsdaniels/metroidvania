...
Defines player-specific health handling, `PlayerHurt` reaction state in the finite state machine, knockback physics, input locking during hitstun, and visual invulnerability blinking feedback.
